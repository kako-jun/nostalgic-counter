...
JavaScript が動作する環境ならば OK なので、GitHub Pages などの静的サイトにも設置できます。
...
どちらもソースコードを公開しているので、自分で借りたクラウドに設置することも、改造することも可能です。

## Description

### Demo

[デモ](https://nostalgic-counter.llll-ll.com/demo)
...
（`ff2` という ID のカウンターを、`nobara` というパスワードを設定して作る場合）
